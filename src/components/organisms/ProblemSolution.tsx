...
export default function ProblemSolution() {
  ...
  const problems = [
    { icon: '📊', text: '貢献の見える化が難しい' },
    { icon: '🧮', text: '報酬配分の計算が煩雑' },
    { icon: '🔄', text: 'ボランティアが続かない' },
    { icon: '💬', text: '活動説明が難しい' }
  ];

  const solutions = [
    { icon: '⚡', text: 'アシストクレジットで即時記録' },
    { icon: '🤖', text: '一度設定すれば自動で分配' },
    { icon: '🎯', text: '貢献がトークンに' },
    { icon: '📈', text: '活動履歴として可視化' }
  ];
      ...
      <div style={containerStyle}>
        <div style={headerStyle}>
          <h2 style={{
            ...
            協働プロジェクトの現場の<br />
            <span style={highlightStyle}>「よくある困りごと」</span><br />
            Tobanが全て解決します
          </h2>
        </div>
        ...
        <div style={{
          ...
          <div style={{
            ...cardStyle,
            background: 'linear-gradient(135deg, #ff6b6b10 0%, #ee5a6f10 100%)',
            borderLeft: '4px solid #ff6b6b',
            padding: isMobile ? '25px 20px' : '40px',
            ...(isVisible ? { ...animationStyle, animationDelay: '0.2s' } : {})
          }}>
          ...
          {isMobile && (
            <div style={{
              ...
              <div style={{
                fontSize: '2rem',
                color: '#64748b',
                ...(isVisible ? { animation: 'bounceIn 1s ease-out 0.5s forwards' } : {})
              }}>
                ↓
              </div>
            </div>
          ...
          <div style={{
            ...
            padding: isMobile ? '25px 20px' : '40px',
            ...(isVisible ? { ...animationStyle, animationDelay: '0.3s' } : {})
          }}>
            <div style={cardHeaderStyle}>
