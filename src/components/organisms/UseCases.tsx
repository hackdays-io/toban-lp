...
export default function UseCases() {
  ...
  const cases = [
    ...
    { 
      ...
      value: '「成果が見える」コミュニティ施策として社内説明・承認が取りやすくなる'
    },
    { 
      ...
      value: '貢献が「忘れられない・不公平にならない」仕組みで、持続的なコミュニティ運営が可能'
    },
    { 
      title: 'コミュニティ創設者さん・\n運営者さんへ', 
      subtitle: '',
      ...
      value: '信頼できる仕組みで、コミュニティをゼロからでも安心して立ち上げられる'
    }
  ];
        ...
        <div style={gridStyle}>
          {cases.map((item, index) => (
            ...
            >
              <div style={{
                ...iconContainerStyle,
                backgroundColor: hoveredCard === index ? 'rgba(255, 255, 255, 0.2)' : item.color + '20',
                ...
                {selectedCard !== index && (
                  <div style={previewStyle}>
                    <div style={previewSectionStyle}>
                      ...
                      <p style={{
                        ...previewTextStyle,
                        color: hoveredCard === index ? 'rgba(255, 255, 255, 0.9)' : '#64748b'
                      }}>
                        ...
                        {item.challenges.map((challenge, i) => (
                          <li key={i} style={{
                            ...
                            <span style={{
                              ...
                              left: '0',
                              top: '0',
                              color: hoveredCard === index ? 'rgba(255, 255, 255, 0.7)' : '#ef4444'
                            }}>•</span>
                            {challenge}
                          </li>
                        ))}
                        ...
                        {item.solutions.map((solution, i) => (
                          <li key={i} style={{
                            ...
                            <span style={{
                              ...
                              left: '0',
                              top: '0',
                              color: hoveredCard === index ? 'rgba(255, 255, 255, 0.7)' : '#10b981'
                            }}>✓</span>
                            {solution}
                          </li>
                        ))}
              ...
              <div style={{
                ...cardFooterStyle,
                borderTopColor: hoveredCard === index ? 'rgba(255, 255, 255, 0.2)' : '#f1f5f9'
              }}>
                <span style={{
                  ...learnMoreStyle,
                  color: hoveredCard === index ? 'white' : item.color
              ...
              {hoveredCard === index && (
                <div style={decorationStyle}>
                  <div style={decoration1Style}></div>
