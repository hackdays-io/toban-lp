        ...
        <div style={gridStyle}>
          {cases.map((caseItem, index) => (
            ...
            >
              ...
              <div style={{
                ...statusBadgeStyle,
                backgroundColor: caseItem.status === 'active' ? '#10b981' : '#f59e0b',
                color: 'white'
              }}>
              ...
              <div style={{
                ...logoSectionStyle,
                borderColor: hoveredCard === index ? caseItem.color : '#e2e8f0'
              }}>
                {caseItem.logoSrc ? (
                  <Image 
              ...
              <div style={{
                ...footerStyle,
                borderTopColor: hoveredCard === index ? caseItem.color + '20' : '#f1f5f9'
              }}>
                {caseItem.linkUrl ? (
                  <a 
