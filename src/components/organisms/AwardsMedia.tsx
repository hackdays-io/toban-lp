  ...
  const awards = [
    {
      ...
      color: '#ff6b6b',
      links: [
        { url: 'https://www.linkedin.com/posts/haruki-kondo-517073204_selected-as-a-finalist-for-eth-tokyo-2024-activity-7233684980688642048-GJIh?utm_source=chatgpt.com', text: 'linkedin.com' }
      ]
    },
    {
      ...
      color: '#4ecdc4',
      links: [
        { url: 'https://ethglobal.com/events/agents?utm_source=chatgpt.com', text: 'ethglobal.com' }
      ]
    },
    {
      ...
      color: '#45b7d1',
      links: [
        { url: 'https://technode.global/2023/03/22/fracton-ventures-shaping-the-web3-landscape-through-strategic-incubation-and-global-collaboration-qa/?utm_source=chatgpt.com', text: 'technode.global' }
      ]
    },
    {
      ...
      color: '#8b5cf6',
      links: [
        { url: 'https://www.dlnews.com/research/internal/ethtaipei-2025-partners-with-ethglobal-vitalik-buterin/?utm_source=chatgpt.com', text: 'ethtaipei.org' }
      ]
    },
    {
      ...
      color: '#f59e0b',
      links: [
        { url: 'https://dalab.xyz/en/project/weekly-gm/?utm_source=chatgpt.com', text: 'dalab.xyz' }
      ]
    }
  ];
            ...
            >
              ...
              <div style={{
                ...
                <div style={cardHeaderStyle}>
                  <div style={{
                    ...typeBadgeStyle,
                    backgroundColor: activeItem === index ? award.color : award.color + '20',
