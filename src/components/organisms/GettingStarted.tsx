...
export default function GettingStarted() {
  ...
  const roles = [
    { 
      ...
      icon: '👥',
      color: '#3b82f6',
      description: 'プロジェクトに参加してタスクを完了し、貢献の履歴を積み重ねていきます。',
    ...
    { 
      ...
      icon: '💝',
      color: '#10b981',
      description: 'プロジェクトを資金面で支援し、コミュニティの発展に貢献します。',
    ...
    <section id="getting-started" style={sectionStyle}>
      <div style={containerStyle}>
        <div style={headerStyle}>
          <h2 style={titleStyle}>
            <span style={highlightStyle}>参加方法</span><br />
            Getting Started
          </h2>
        ...
        <div style={rolesGridStyle}>
          {roles.map((item, index) => (
            ...
            >
              ...
              <div style={{
                ...costBadgeStyle,
                backgroundColor: item.initialCost === '0 ETH' ? '#10b981' : item.color,
                color: 'white',
                position: 'absolute',
                top: '20px',
                right: '20px'
                ...
                <div style={benefitsStyle}>
                  ...
                  <ul style={benefitsListStyle}>
                    {item.benefits.map((benefit, benefitIndex) => (
                      <li key={benefitIndex} style={benefitItemStyle}>
                        <span style={{
                          ...benefitIconStyle,
                          color: item.color
                        }}>✓</span>
              ...
              <div style={cardFooterStyle}>
                <button 
                  style={{
                    ...ctaButtonStyle,
                    backgroundColor: selectedRole === index ? item.color : 'transparent',
        ...
        <div style={mainCtaStyle}>
          <div style={ctaContentStyle}>
            ...
            <div style={ctaButtonsStyle}>
              <button style={primaryCtaButtonStyle}>
